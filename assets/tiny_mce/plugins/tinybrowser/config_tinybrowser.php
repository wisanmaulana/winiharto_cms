...
session_start();
$tinybrowser['sessioncheck'] = 'login'; //name of session variable to check
if($_SESSION[$tinybrowser['sessioncheck']]='LOGIN'){
	$_SESSION[$tinybrowser['sessioncheck']]='LOGIN';
}	

// Random string used to secure Flash upload if session control not enabled - be sure to change!
$tinybrowser['obfuscate'] = 'utiqshiroincube';
