<?php echo form_open_multipart('Brand_cms/addBrand');?>


<!-- HEADER -->
<div class="modal-header" style="background-color: #f5aa42  ;padding: 0.2rem;">
  <p style="color: white;margin-top: 0.5em; margin-left: 0.5em; font-size: 20px; font-weight: bold;">Add Brand</p>
...
<div class="modal-body" style="font-size: 14px;">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="desc_brand" class="form-control">
    </div>
  </div>
