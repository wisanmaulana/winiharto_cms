...
# Dump of table g_about_company
# ------------------------------------------------------------

DROP TABLE IF EXISTS `g_about_company`;

CREATE TABLE `g_about_company` (
  `REC_ID` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `CONTENT` text,
  PRIMARY KEY (`REC_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `g_about_company` WRITE;
/*!40000 ALTER TABLE `g_about_company` DISABLE KEYS */;

INSERT INTO `g_about_company` (`REC_ID`, `CONTENT`)
VALUES
	(1,'<ul>\r\n<li>about us</li>\r\n</ul>');

/*!40000 ALTER TABLE `g_about_company` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table g_brand
# ------------------------------------------------------------
...
LOCK TABLES `g_brand` WRITE;
/*!40000 ALTER TABLE `g_brand` DISABLE KEYS */;

INSERT INTO `g_brand` (`REC_ID`, `ID`, `NAME`, `DESCRIPTION`)
VALUES
	(1,'SARTORIUS','Sartorius','Sartorius'),
	(2,'MINEBEA','Minebea Intec','Minebea Intec'),
	(3,'FLINTEC','Flintec','Flintec'),
	(4,'GCC','GCC Scales','GCC Scales'),
	(5,'BANZAI','Banzai','Banzai');

/*!40000 ALTER TABLE `g_brand` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table g_brand_category
# ------------------------------------------------------------

DROP TABLE IF EXISTS `g_brand_category`;

CREATE TABLE `g_brand_category` (
  `REC_ID` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `g_brand_category` WRITE;
/*!40000 ALTER TABLE `g_brand_category` DISABLE KEYS */;

INSERT INTO `g_brand_category` (`REC_ID`, `BRAND_ID`, `CATEGORY_ID`, `NAME`, `PARENT_ID`)
VALUES
	(7,'BANZAI','BNZ-02','Side Slip Tster','0'),
	(8,'BANZAI','BNZ-03','Axle Load Meter','0'),
	(9,'BANZAI','BNZ-04','Compressor','0'),
	(10,'BANZAI','BNZ-05','Head Light Tester','0'),
	(11,'BANZAI','BNZ-06','CO/HC Exhaust Emission Analyzer','0'),
	(12,'BANZAI','BNZ-07','Axle Play Detecter','0'),
	(13,'BANZAI','BNZ-08','Sound Level Meter','0'),
	(14,'BANZAI','BNZ-09','Diesel Smoke Meter','0'),
	(15,'BANZAI','BNZ-10','Pit Lift','0'),
	(16,'MINEBEA INTEC','MNB-01','Load Cells','0'),
	(17,'MINEBEA INTEC','MNB-02','Weight Indicator','0'),
	(18,'MINEBEA INTEC','MNB-05','Bench & Floor Scales','0'),
	(19,'MINEBEA INTEC','MNB-06','Ex Solutions','0'),
	(20,'MINEBEA INTEC','MNB-07','Process Software','0'),
	(21,'MINEBEA INTEC','MNB-08','Tanks and Hoppers','0'),
	(22,'MINEBEA INTEC','MNB-L-01','Vesel and Silos Scales','MNB-01'),
	(23,'MINEBEA INTEC','MNB-L-02','Bench & Floor Scales & Machines','MNB-01'),
	(24,'MINEBEA INTEC','MNB-L-03','Truck Scales','MNB-01'),
	(25,'MINEBEA INTEC','MNB-L-04','Hygienic Design','MNB-01'),
	(26,'MINEBEA INTEC','MNB-W-01','Weight Terminals for Vessels and Silos Scales','MNB-02'),
	(27,'MINEBEA INTEC','MNB-W-02','Programmable Weight Terminal','MNB-02'),
	(28,'MINEBEA INTEC','MNB-W-03','Weight Indicator for Bench & Floor Scales','MNB-02'),
	(29,'MINEBEA INTEC','MNB-W-04','Truck Scales','MNB-02'),
	(30,'MINEBEA INTEC','MNB-F-01','Industrial Metal Detector','MNB-03'),
	(31,'MINEBEA INTEC','MNB-F-02','X-Ray Inspection for Packaged Food','MNB-03'),
	(32,'MINEBEA INTEC','MNB-F-03','X-Ray Inspection for Bottles, Cans, and Jars','MNB-03'),
	(33,'MINEBEA INTEC','MNB-F-04','X-Ray Inspection for Bulk Material','MNB-03'),
	(34,'MINEBEA INTEC','MNB-C-01','Checkweigher Metal & Detector Combination','MNB-04'),
	(35,'MINEBEA INTEC','MNB-C-02','End of Line Checkweighers','MNB-04'),
	(36,'MINEBEA INTEC','MNB-C-03','In-Line Checkweighers ','MNB-04'),
	(37,'MINEBEA INTEC','MNB-C-04','OEM Weighing Kit','MNB-04'),
	(38,'MINEBEA INTEC','MNB-B-01','Complete Scales','MNB-05'),
	(39,'MINEBEA INTEC','MNB-B-02','Weighing Platform & Floor Scales','MNB-05'),
	(40,'MINEBEA INTEC','MNB-B-03','Pallet Scales','MNB-05'),
	(41,'MINEBEA INTEC','MNB-B-04','High Resolution Scales','MNB-05'),
	(42,'MINEBEA INTEC','MNB-H-01','Load Cells for Hazardous Area','MNB-06'),
	(43,'MINEBEA INTEC','MNB-H-02','Bench and Floor Scales for Hazardous Area','MNB-06'),
	(44,'MINEBEA INTEC','MNB-H-03','Weighing Terminal for Hazardous Area','MNB-06'),
	(45,'MINEBEA INTEC','MNB-P-01','Statistical Process Control','MNB-07'),
	(46,'MINEBEA INTEC','MNB-P-02','Batching & Formulation','MNB-07'),
	(47,'MINEBEA INTEC','MNB-P-03','Software Tools','MNB-07'),
	(48,'FLINTEC','FTC-S-01','Beam Load Cells','FTC-01'),
	(49,'FLINTEC','FTC-S-02','Single Point Load Cells','FTC-01'),
	(50,'FLINTEC','FTC-S-03','Compression Load Cells','FTC-01'),
	(51,'FLINTEC','FTC-S-04','Planar Beam Load Cells','FTC-01'),
	(52,'FLINTEC','FTC-S-05','Tension Load Cells','FTC-01'),
	(53,'FLINTEC','FTC-S-06','Load Cell Mounts','FTC-01'),
	(54,'SARTORIUS','SRS-M-02','Automatic Mass Comparator','SRS-01'),
	(55,'SARTORIUS','SRS-M-03','Manual Mass Comparator','SRS-01'),
	(56,'SARTORIUS','SRS-M-04','Robot System','SRS-01'),
	(57,'SARTORIUS','SRS-M-05','System','SRS-01'),
	(58,'SARTORIUS','SRS-M-06','Susceptometer','SRS-01'),
	(59,'SARTORIUS','SRS-M-07','Volume and Density Determination','SRS-01'),
	(60,'SARTORIUS','SRS-L-01','Ultramicro | Micro','SRS-02'),
	(61,'SARTORIUS','SRS-L-02','Analytical','SRS-02'),
	(62,'SARTORIUS','SRS-L-03','Precision','SRS-02'),
	(63,'SARTORIUS','SRS-P-01','Paint Mixing Scales','SRS-05'),
	(64,'SARTORIUS','SRS-P-02','Paint Mixing Terminals','SRS-05'),
	(65,'SARTORIUS','SRS-P-03','Paint Mixing Accesories','SRS-05'),
	(66,'SARTORIUS','SRS-W-01','Accesories for Weight and Weight Sets','SRS-06'),
	(67,'SARTORIUS','SRS-W-02','Cylindrical Weights','SRS-06'),
	(68,'SARTORIUS','SRS-W-03','Knob Weights','SRS-06'),
	(69,'SARTORIUS','SRS-W-04','Leaf Weights','SRS-06'),
	(70,'SARTORIUS','SRS-W-05','Weight Sets','SRS-06'),
	(71,'SARTORIUS','SRS-W-06','Wire Weights','SRS-06'),
	(72,'SARTORIUS','SRS-A-01','Moisture Meter LMA200','SRS-03'),
	(73,'SARTORIUS','SRS-A-02','Moisture Meter MA','SRS-03'),
	(74,'SARTORIUS','SRS-A-03','Mark 3 Moisture Analyzer','SRS-03'),
	(75,'SARTORIUS','SRS-01','Mass Comparator & Metrology','0'),
	(76,'SARTORIUS','SRS-02','Laboratory Balances ','0'),
	(77,'SARTORIUS','SRS-03','Moisture Analyzers','0'),
	(78,'SARTORIUS','SRS-04','Gold & Carat Balances','0'),
	(79,'SARTORIUS','SRS-05','Paint Mixing Systems','0'),
	(80,'SARTORIUS','SRS-06','Weights | Weight Set','0'),
	(81,'FLINTEC','FTC-02','Weighing Indicator','0'),
	(82,'FLINTEC','FTC-01','Load Cells','0'),
	(83,'GCC','GCC-09','Weighing Indicator','0'),
	(84,'GCC','GCC-08','Truck Scales','0'),
	(85,'GCC','GCC-07','Pallet Truck Scales','0'),
	(86,'GCC','GCC-06','Logicstic Scales','0'),
	(87,'GCC','GCC-05','Floor Scales','0'),
	(88,'GCC','GCC-04','Crane Scales','0'),
	(89,'GCC','GCC-03','Bench Scales','0'),
	(90,'GCC','GCC-02','Axle Scales','0'),
	(91,'GCC','GCC-01','Animal Scales','0');

/*!40000 ALTER TABLE `g_brand_category` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table g_customer
# ------------------------------------------------------------
...
INSERT INTO `g_customer` (`REC_ID`, `CONTENT`)
VALUES
...
# Dump of table g_distribution_history
# ------------------------------------------------------------

DROP TABLE IF EXISTS `g_distribution_history`;

CREATE TABLE `g_distribution_history` (
  `REC_ID` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `CONTENT` text,
  PRIMARY KEY (`REC_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `g_distribution_history` WRITE;
/*!40000 ALTER TABLE `g_distribution_history` DISABLE KEYS */;

INSERT INTO `g_distribution_history` (`REC_ID`, `CONTENT`)
VALUES
	(1,'<p>History Winiharto</p>');

/*!40000 ALTER TABLE `g_distribution_history` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table g_latest_news
# ------------------------------------------------------------

DROP TABLE IF EXISTS `g_latest_news`;

CREATE TABLE `g_latest_news` (
  `REC_ID` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `CONTENT` text,
  PRIMARY KEY (`REC_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `g_latest_news` WRITE;
/*!40000 ALTER TABLE `g_latest_news` DISABLE KEYS */;

INSERT INTO `g_latest_news` (`REC_ID`, `CONTENT`)
VALUES
	(1,'<p>Berita hari ini dipersembahkan oleh</p>');

/*!40000 ALTER TABLE `g_latest_news` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table g_navigation
# ------------------------------------------------------------
...
CREATE TABLE `g_navigation` (
  `REC_ID` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `NAV_ID` varchar(50) DEFAULT NULL,
...
LOCK TABLES `g_navigation` WRITE;
/*!40000 ALTER TABLE `g_navigation` DISABLE KEYS */;

INSERT INTO `g_navigation` (`REC_ID`, `NAV_ID`, `NAME`, `PARENT`, `LINK`)
VALUES
	(1,'HOME','Home',0,'home'),
	(2,'ABOUT','Abous Us',0,''),
	(3,'ABOUT_COMPANY','About the Company',2,'about_us'),
	(4,'ABOUT_VISION','Vision & Mission',2,'vision'),
	(5,'ABOUT_CUSTOMERS','Our Customers',2,'customers'),
	(6,'BRANDS','Our Brands',0,''),
	(7,'MINEBEA INTEC','Minebea Intec',6,''),
	(8,'BANZAI','Banzai',6,''),
	(9,'SARTORIUS','Sartorius',6,''),
	(10,'FLINTEC','Flintec',6,''),
	(11,'GCC','GCC Scales',6,''),
	(12,'PRODUCTS','Our Products',0,''),
	(13,'IND','Industrial Weighing',12,''),
	(14,'BAL','Laboratory Weighing',12,''),
	(15,'GRG','Garage Equipment',12,''),
	(16,'LAB','Lab Equipment',12,''),
	(17,'DISTRIBUTION','Distribution History',0,'distribution'),
	(18,'WORKSHOP','Workshop',0,'workshop'),
	(19,'CONTACT','Contact Us',0,'contacts');

/*!40000 ALTER TABLE `g_navigation` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table g_user
# ------------------------------------------------------------
...
INSERT INTO `g_user` (`user_id`, `user_name`, `user_pass`, `user_group_id`, `user_status`, `user_attempted_login`)
VALUES
...
# Dump of table g_vision
# ------------------------------------------------------------

DROP TABLE IF EXISTS `g_vision`;

CREATE TABLE `g_vision` (
  `REC_ID` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `CONTENT` text,
  PRIMARY KEY (`REC_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `g_vision` WRITE;
/*!40000 ALTER TABLE `g_vision` DISABLE KEYS */;

INSERT INTO `g_vision` (`REC_ID`, `CONTENT`)
VALUES
	(1,'<p>Lorem Ipsum Loroddddddd</p>');

/*!40000 ALTER TABLE `g_vision` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table g_workshop
# ------------------------------------------------------------

DROP TABLE IF EXISTS `g_workshop`;

CREATE TABLE `g_workshop` (
  `REC_ID` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `CONTENT` text,
  PRIMARY KEY (`REC_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `g_workshop` WRITE;
/*!40000 ALTER TABLE `g_workshop` DISABLE KEYS */;

INSERT INTO `g_workshop` (`REC_ID`, `CONTENT`)
VALUES
	(1,'<p>Workshop itu adalah sesuatu hal yang berguna</p>');

/*!40000 ALTER TABLE `g_workshop` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table g_product_category
# ------------------------------------------------------------

DROP TABLE IF EXISTS `g_product_category`;

CREATE TABLE `g_product_category` (
  `REC_ID` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `ID` varchar(30) NOT NULL DEFAULT '',
...
LOCK TABLES `g_product_category` WRITE;
/*!40000 ALTER TABLE `g_product_category` DISABLE KEYS */;

INSERT INTO `g_product_category` (`REC_ID`, `ID`, `NAME`, `DESCRIPTION`, `ORDER_NO`, `DIVISION`)
VALUES
	(1,'BAL-02','Laboratory Balances','BAL','LB01','BAL'),
	(2,'CAT002','pHMeters','LAB','LB02','LAB'),
	(3,'BAL-03','Moisture Analyzers','BAL','LB03','BAL'),
	(4,'CAT004','Centrifuges','LAB','LB04','LAB'),
	(5,'CAT005','Incubator, Shakers and Stirrer','LAB','LB05','LAB'),
	(6,'CAT006','Homogenizers','LAB','LB05','LAB'),
	(7,'CAT007','Spectrophotometers','LAB','LB07','LAB'),
	(8,'IND-01','Bench Scales','IND','IND01','IND'),
	(9,'IND-02','Tank and Silo Weighing','IND','IND04','IND'),
	(10,'IND-03','Truck Scales','IND','IND05','IND'),
	(11,'BAL-01','Mass Comparator','BAL','LB08','BAL'),
	(12,'BAL-06','Weights | Weight Sets','BAL','LB09','BAL'),
	(13,'CAT010','Refractometers','LAB','LB10','LAB'),
	(14,'CAT011','Lab Water System','LAB','LB11','LAB'),
	(15,'CAT019','Laboratory Waterbaths ','LAB','LB19','LAB'),
	(16,'CAT013','CETI Microscopes ','LAB','LB13','LAB'),
	(17,'CAT014','Liquid Handling System','LAB','LB14','LAB'),
	(18,'CAT015','Camera Analysis and Software -','LAB','LB15','LAB'),
	(19,'CAT018','Laboratory Oven ','LAB','LB18','LAB'),
	(20,'CAT020','Polarimeters ','LAB','LB20','LAB'),
	(21,'IND-05','Ex Weighing Equipment','IND','IND03','IND'),
	(22,'IND-06','Software','OTH','OTH02','OTH'),
	(23,'IND-07','Calibration Certificate','OTH','OTH03','OTH'),
	(24,'IND-04','Platform Scales and Load Cells','IND','IND02','IND'),
	(25,'CAT023','Bench Top Equipments','LAB','LB23','LAB'),
	(26,'GRG-01','Generator Set','GRG','GRG01','GRG'),
	(27,'GRG-02','Side Slip Tester','GRG','GRG02','GRG'),
	(28,'GRG-03','Axle Load Meter','GRG','GRG03','GRG'),
	(29,'GRG-04','Compressor','GRG','GRG04','GRG'),
	(30,'GRG-05','Head Light Tester','GRG','GRG05','GRG'),
	(31,'GRG-06','CO/HC Exhaust Emission Analyzer','GRG','GRG06','GRG'),
	(32,'GRG-07','Axle Play Detector','GRG','GRG07','GRG'),
	(33,'GRG-08','Sound Level Meter','GRG','GRG08','GRG'),
	(34,'GRG-09','Diesel Smoke Meter','GRG','GRG09','GRG'),
	(35,'GRG-10','Pit Lift','GRG','GRG10','GRG');

/*!40000 ALTER TABLE `g_product_category` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table p_new_products
# ------------------------------------------------------------

DROP TABLE IF EXISTS `p_new_products`;

CREATE TABLE `p_new_products` (
...
LOCK TABLES `p_new_products` WRITE;
/*!40000 ALTER TABLE `p_new_products` DISABLE KEYS */;

INSERT INTO `p_new_products` (`PROD_ID`, `NAME`, `PRODUCT_ID`, `BRAND_CATEGORY`, `BRAND_ID`, `BRAND_SUBCATEGORY`, `SUMMARY`, `IMAGES`)
VALUES
...
/*!40000 ALTER TABLE `p_new_products` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table p_subcategory
# ------------------------------------------------------------
...
INSERT INTO `p_subcategory` (`ID`, `CATEGORY_NAME`, `DESCRIPTION`, `ORDER_NO`, `CATEGORY_ID`)
VALUES
...
INSERT INTO `s_appl_detail` (`APPL_ID`, `ID`, `DESCRIPTION`, `ORDER_NO`)
VALUES
...
INSERT INTO `s_group_appl` (`GROUP_ID`, `APPL_ID`, `ROLE`)
VALUES
...
LOCK TABLES `w_type` WRITE;
/*!40000 ALTER TABLE `w_type` DISABLE KEYS */;

INSERT INTO `w_type` (`ID`, `NAME`, `DESCRIPTION`, `ORDER_NO`)
VALUES
	('BAL','Laboratory Weighing','','2'),
	('IND','Industrial Weighing','','1'),
	('LAB','Laboratory Equipment','','3');

/*!40000 ALTER TABLE `w_type` ENABLE KEYS */;
UNLOCK TABLES;
